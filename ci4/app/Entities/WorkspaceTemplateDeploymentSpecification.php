...
/**
 * Class WorkspaceTemplateDeploymentSpecification
 ...
 */
class WorkspaceTemplateDeploymentSpecification extends Entity {

    /**
     * @param \App\Interfaces\WorkspaceTemplateDeploymentSpecification $data
     * @return WorkspaceTemplateDeploymentSpecification
     */
    public static function Create($data): WorkspaceTemplateDeploymentSpecification {
        $item = new WorkspaceTemplateDeploymentSpecification();
    ...
    /**
     * @return \ArrayIterator|\OrmExtension\Extensions\Entity[]|\Traversable|WorkspaceTemplateDeploymentSpecification[]
     */
