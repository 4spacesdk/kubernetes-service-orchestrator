...
export interface WorkspaceUpdateIngressDialog_Input {
    workspace: Workspace;
}

const props = defineProps<{ input: WorkspaceUpdateIngressDialog_Input, events: DialogEventsInterface }>();
...
function render() {
    domainId.value = props.input.workspace.domain_id;
    subdomain.value = props.input.workspace.subdomain ?? '';
    aliases.value = props.input.workspace.aliases ?? '';
    const deploymentStatus = props.input.workspace.status;
    isDomainEnaled.value = deploymentStatus === DeploymentStatusTypes.Draft;
    isSubdomainEnabled.value = deploymentStatus === DeploymentStatusTypes.Draft;
...
function onSaveBtnClicked() {
    const api = Api.workspaces().updateIngressPutById(props.input.workspace.id!)
