...
export interface WorkspaceLogsDialog_Input {
    workspace: Workspace;
}

const props = defineProps<{ input: WorkspaceLogsDialog_Input, events: DialogEventsInterface }>();
...
<template>
    <v-dialog
        ...
        <v-card
            ...
            <v-card-title>
                <div class="d-flex">
                    <span class="my-auto">Workspace Kubernetes Logs</span>
                    <v-chip class="my-auto mx-auto">{{ props.input.workspace.name_system }}.{{ props.input.workspace.namespace }}</v-chip>
                </div>
            </v-card-title>
            <v-divider/>
            <v-card-text>
                <KubernetesLogList
                    ...
                    :show-header="false"
                    :namespace="props.input.workspace.namespace"/>
            </v-card-text>
            <v-divider/>
            <v-card-actions>
                <v-btn
