...
export interface WorkspaceTemplateUpdateLabelsDialog_Input {
...
const props = defineProps<{ input: WorkspaceTemplateUpdateLabelsDialog_Input, events: DialogEventsInterface }>();
...
function onCreateBtnClicked() {
    ...
    bus.emit('workspaceTemplateUpdateLabel', {
        label: newItem,
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.workspaceTemplates().updateLabelsPutByWorkspaceTemplateId(props.input.workspaceTemplate.id!);
