...
export interface WorkspaceTemplateUpdateDeploymentSpecificationKNativeMinScaleSchedulesDialog_Input {
...
const props = defineProps<{
    input: WorkspaceTemplateUpdateDeploymentSpecificationKNativeMinScaleSchedulesDialog_Input,
