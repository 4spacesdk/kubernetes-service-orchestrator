...
export interface DeploymentPackageUpdateLabelsDialog_Input {
...
const props = defineProps<{ input: DeploymentPackageUpdateLabelsDialog_Input, events: DialogEventsInterface }>();
...
function onCreateBtnClicked() {
    ...
    bus.emit('deploymentPackageUpdateLabel', {
        label: newItem,
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.deploymentPackages().updateLabelsPutByDeploymentPackageId(props.input.deploymentPackage.id!);
