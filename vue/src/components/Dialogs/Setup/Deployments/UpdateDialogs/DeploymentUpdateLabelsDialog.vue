...
export interface DeploymentUpdateLabelsDialog_Input {
...
const props = defineProps<{ input: DeploymentUpdateLabelsDialog_Input, events: DialogEventsInterface }>();
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.deployments().updateLabelsPutById(props.input.deployment.id!);
