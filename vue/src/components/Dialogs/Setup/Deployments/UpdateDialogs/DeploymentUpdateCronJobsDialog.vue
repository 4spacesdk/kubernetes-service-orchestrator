...
export interface DeploymentUpdateCronJobsDialog_Input {
...
const props = defineProps<{
    input: DeploymentUpdateCronJobsDialog_Input,
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.deployments().updateCronJobsPutById(props.input.deployment.id!);
