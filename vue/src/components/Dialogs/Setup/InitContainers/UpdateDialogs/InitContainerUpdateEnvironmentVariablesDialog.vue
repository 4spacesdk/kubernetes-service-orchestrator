...
export interface InitContainerUpdateEnvironmentVariablesDialog_Input {
...
function render() {
    ...
    Api.initContainers().get()
        .where('id', props.input.initContainer.id!)
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.initContainers().updateEnvironmentVariablesPutById(props.input.initContainer.id!);
        ...
        <v-card
            ...
            <v-card-title>
                <div class="d-flex w-100">
                    ...
                    <v-chip class="my-auto mx-auto">{{ props.input.initContainer.name }}</v-chip>
