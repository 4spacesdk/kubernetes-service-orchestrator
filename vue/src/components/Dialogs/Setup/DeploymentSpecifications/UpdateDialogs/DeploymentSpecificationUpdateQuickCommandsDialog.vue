...
export interface DeploymentSpecificationUpdateQuickCommandsDialog_Input {
...
const props = defineProps<{ input: DeploymentSpecificationUpdateQuickCommandsDialog_Input, events: DialogEventsInterface }>();
...
function render() {
    ...
    Api.deploymentSpecifications().get()
        ...
        .find(value => {
            let pos = 0;
            rows.value = value[0].deployment_specification_quick_commands
                ?.map(quickCommand => {
                    return {
...
function onCreateBtnClicked() {
    ...
    bus.emit('deploymentSpecificationUpdateQuickCommand', {
        quickCommand: newItem,
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.deploymentSpecifications().updateQuickCommandsPutById(props.input.deploymentSpecification.id!);
        ...
        <v-card
            ...
            <v-card-title>
                <div class="d-flex w-100">
                    <span class="my-auto">Quick Commands</span>
