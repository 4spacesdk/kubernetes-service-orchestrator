...
export interface DeploymentSpecificationUpdateRoleRulesDialog_Input {
...
const props = defineProps<{ input: DeploymentSpecificationUpdateRoleRulesDialog_Input, events: DialogEventsInterface }>();
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.deploymentSpecifications().updateRoleRulesPutById(props.input.deploymentSpecification.id!);
        ...
        <v-card
            ...
            <v-card-title>
                <div class="d-flex w-100">
                    <span class="my-auto">Role Rules</span>
