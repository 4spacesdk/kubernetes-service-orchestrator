...
const props = defineProps<{ input: DeploymentSpecificationUpdateIngressRulePathsDialog_Input, events: DialogEventsInterface }>();
...
const headers = ref([
    ...
    {title: 'Path Type', key: 'pathType', sortable: false},
    {title: 'Backend Service Port Name', key: 'backendServicePortName', sortable: false},
        ...
        <v-card
            ...
            <v-card-title>
                <div class="d-flex w-100">
                    <span class="my-auto">Ingress Rule Paths</span>
