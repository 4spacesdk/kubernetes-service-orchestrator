...
export interface DeploymentSpecificationUpdateVolumesDialog_Input {
    deploymentSpecification: DeploymentSpecification;
}

const props = defineProps<{ input: DeploymentSpecificationUpdateVolumesDialog_Input, events: DialogEventsInterface }>();
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.deploymentSpecifications().updateVolumesPutById(props.input.deploymentSpecification.id!);
