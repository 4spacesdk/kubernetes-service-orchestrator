...
export interface DeploymentSpecificationUpdateLabelsDialog_Input {
...
const props = defineProps<{ input: DeploymentSpecificationUpdateLabelsDialog_Input, events: DialogEventsInterface }>();
...
function onCreateBtnClicked() {
    ...
    bus.emit('deploymentSpecificationUpdateLabel', {
        label: newItem,
...
function onSaveBtnClicked() {
    isSaving.value = true;
    const api = Api.deploymentSpecifications().updateLabelsPutById(props.input.deploymentSpecification.id!);
