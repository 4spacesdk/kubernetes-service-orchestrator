...
function onSaveBtnClicked() {
    value.value!.is_network_nginx_ingress_supported =
        selectedNetworkTypes.value.includes(NetworkTypes.NginxIngress);
    value.value!.is_network_istio_supported =
        selectedNetworkTypes.value.includes(NetworkTypes.Istio);
    value.value!.is_network_contour_supported =
        selectedNetworkTypes.value.includes(NetworkTypes.Contour);
    value.value!.is_network_gateway_api_supported =
        selectedNetworkTypes.value.includes(NetworkTypes.GatewayApi);
    Api.systems()
