...
export class KNativeMinScaleScheduleDefinition extends BaseModel {
    min_scale?: number;
    ...
    public populate(data?: any, patch = false) {
        if (!patch) {
            delete this.min_scale;
            delete this.cron_expression;
        ...
        if (!data) return;
        if (data.min_scale != null) {
            this.min_scale = data.min_scale;
        }
